...
dojo.declare("extras.ClusterLayer", esri.layers.GraphicsLayer, {
  constructor: function(options) {
    ...
    this._clusterTolerance = options.distance || 500;
  ...
  */
  ...
  _setMap: function(map, surface) {
    ...
    this._clusterResolution = (map.extent.getWidth() / map.width) / this._params.resolutionFactor; // probably a bad default...
    ...
    this._zoomEnd = dojo.connect(map, "onZoomEnd", this, function() {
      // update resolution
      this._clusterResolution = (this._map.extent.getWidth() / this._map.width)  / this._params.resolutionFactor;
      this.clear();
      this._clusterGraphics();
    });
